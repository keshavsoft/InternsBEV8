...
let postFilterDataFromBodyFunc = (req, res) => {
	...
	let LocalCoumngpsAccuracy = LocalRequestBody.gpsAccuracy;
	let LocalCoumngpsLng = LocalRequestBody.gpsLng;
	let LocalCoumngpsLat = LocalRequestBody.gpsLat;
	let LocalCoumnisEmailVerified = LocalRequestBody.isEmailVerified;
